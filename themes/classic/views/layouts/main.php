...
<html class="no-js">
	...
	<head>
		...
		<![endif]-->
		<link rel="stylesheet" media="all" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/style.css"/>
		...
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.columnizer.min.js"></script>
		
		<!-- Isotope -->
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.isotope.min.js"></script>
		
		<!-- Lof slider -->
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.easing.js"></script>
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/lof-slider.js"></script>
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/lof-slider.css" media="all"  /> 
		<!-- ENDS slider -->
		
		<!-- Tweet -->
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/jquery.tweet.css" media="all"  /> 
		<script src="<?php echo Yii::app()->theme->baseUrl; ?>/js/tweet/jquery.tweet.js" ></script> 
		<!-- ENDS Tweet -->
		
		<!-- superfish -->
		<link rel="stylesheet" media="screen" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/superfish.css" /> 
		<script  src="<?php echo Yii::app()->theme->baseUrl; ?>/js/superfish-1.4.8/<?php echo Yii::app()->theme->baseUrl; ?>/js/hoverIntent.js"></script>
		<script  src="<?php echo Yii::app()->theme->baseUrl; ?>/js/superfish-1.4.8/<?php echo Yii::app()->theme->baseUrl; ?>/js/superfish.js"></script>
		<script  src="<?php echo Yii::app()->theme->baseUrl; ?>/js/superfish-1.4.8/<?php echo Yii::app()->theme->baseUrl; ?>/js/supersubs.js"></script>
		<!-- ENDS superfish -->
		
		<!-- prettyPhoto -->
		<script  src="<?php echo Yii::app()->theme->baseUrl; ?>/js/prettyPhoto/<?php echo Yii::app()->theme->baseUrl; ?>/js/jquery.prettyPhoto.js"></script>
		<link rel="stylesheet" href="<?php echo Yii::app()->theme->baseUrl; ?>/js/prettyPhoto/<?php echo Yii::app()->theme->baseUrl; ?>/css/prettyPhoto.css"  media="screen" />
		<!-- ENDS prettyPhoto -->
		...
		<link rel="stylesheet" media="screen" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/carousel.css" /> 
		<!-- ENDS JCarousel -->
		...
		<div id="main">
			...
			<div class="home-featured">
				...
				<div id="filter-container" class="cf">
					<figure class="web">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/01.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="print">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/02.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="design">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/03.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="photo">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/04.jpg" alt="alt" /></a>
						<figcaption>
							<a href="project.html" ><h3 class="heading">Pellentesque habitant morbi</h3></a>
							Tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. </figcaption>
					</figure>
					...
					<figure class="web photo">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/05.jpg" alt="alt" /></a>
						<figcaption>
							<a href="project.html" ><h3 class="heading">Pellentesque habitant morbi</h3></a>
							Tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. </figcaption>
					</figure>
					...
					<figure class="web print">
						<a href="project.html" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/featured/06.jpg" alt="alt" /></a>
						<figcaption>
							<a href="project.html" ><h3 class="heading">Pellentesque habitant morbi</h3></a>
							Tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. </figcaption>
					</figure>
					...
					<li class="first-col">
						...
						<div class="widget-block">
							...
							<div class="recent-post cf">
								<a href="#" class="thumb"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/img/dummies/54x54.gif" alt="Post" /></a>
								<div class="post-head">
